...
class Encryption {
	...
	protected function get_default_key() {
		...
		if ( defined( 'SUREFEEDBACK_ENCRYPTION_KEY' ) && '' !== SUREFEEDBACK_ENCRYPTION_KEY ) {
			return SUREFEEDBACK_ENCRYPTION_KEY;
		}
	...
	private function get_default_salt() {
		if ( defined( 'SUREFEEDBACK_ENCRYPTION_SALT' ) && '' !== SUREFEEDBACK_ENCRYPTION_SALT ) {
			return SUREFEEDBACK_ENCRYPTION_SALT;
		}
