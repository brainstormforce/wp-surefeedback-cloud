...
class SureFeedbackException extends Exception {
	 ...
	 */
	public function __construct( string $message = '', int $code = 0, Exception $previous = null, array $context = array() ) {
	...
	public static function fromWpError( \WP_Error $wp_error ): self {
		...
		$context = is_array( $data ) ? $data : array( 'error_data' => $data );
	 ...
	 * @return static
	 */
	public static function invalidConfiguration( string $message, array $context = array() ): self {
	 ...
	 * @return static
	 */
	public static function apiError( string $message, int $http_code = 500, array $context = array() ): self {
	 ...
	 * @return static
	 */
	public static function authenticationError( string $message, array $context = array() ): self {
	 ...
	 * @return static
	 */
	public static function authorizationError( string $message, array $context = array() ): self {
	 ...
	 * @return static
	 */
	public static function validationError( string $message, array $context = array() ): self {
	 ...
	 * @return static
	 */
	public static function rateLimitError( string $message, array $context = array() ): self {
	 ...
	 * @return static
	 */
	public static function notFoundError( string $message, array $context = array() ): self {
	 ...
	 * @return static
	 */
	public static function serviceUnavailable( string $message, array $context = array() ): self {
